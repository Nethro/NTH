...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, ' ' + wm + '♦️', 'https://www.instagram.com/nethro.gaming'].getRandom(), thumbnail: img.getRandom(), sourceUrl: [md, nna, yt, nn, tiktok].getRandom() }}}}, tg)
