...
await conn.sendFile(m.chat, pp, 'lp.jpg', menu, m, false, { contextInfo: { forwardedNewsletterMessageInfo: { newsletterJid: '120363160031023229@newsletter', serverMessageId: '', newsletterName: '𝙉𝙀𝙏𝙃𝙍𝙊 𝘽𝙊𝙏 ♦️' }, mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝙉𝙀𝙏𝙃𝙍𝙊 𝘽𝙊𝙏 ♦️', previewType: 0, thumbnail: imagen3, sourceUrl: [md, yt, tiktok].getRandom()}}})
